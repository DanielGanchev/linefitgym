...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public SecurityConfig(@Value("${spring.remember.me.key}") String rememberMeKey, UserDetailsServiceImpl userDetailsService){
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests(req ->
                        req.requestMatchers("/resources/**", "/static/**","/","/error","/users/login","users/register","/countries","/api/cities/**","/coach/manager","https://unpkg.com/swiper@7/swiper-bundle.min.css","/users/login-error","/error")
